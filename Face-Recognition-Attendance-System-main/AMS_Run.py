    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def create_csv():
                ...
                csv_name = 'C:/Users/Delwyn Anand P.G/Downloads/delwynminiproject/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"C:/Users/Delwyn Anand P.G/Downloads/delwynminiproject/Face-Recognition-Attendance-System-main/Attendance/Manually Attendance/-------Check attendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='grey80')
                cs = 'C:/Users/Delwyn Anand P.G/Downloads/delwynminiproject/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:/Users/Delwyn Anand P.G/Downloads/delwynminiproject/Face-Recognition-Attendance-System-main/Attendance/-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'delwyn':
            if password == '1234':
                ...
                cs = 'C:/Users/Delwyn Anand P.G/Downloads/delwynminiproject/Face-Recognition-Attendance-System-main/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
